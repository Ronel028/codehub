                ...
                <div className="pb-8">
                    <form>
                        <div className=" grid grid-cols-[70%_27%] gap-[3%]">
                            ...
                            <div className="w-full p-6 mb-4 bg-gray-100 border-dashed border-2 border-gray-400 rounded items-center mx-auto text-center cursor-pointer">
                        ...
                        <div className=" flex items-center justify-end gap-2">
                            <button type="submit" className=" font-bold border border-secondary  py-2 text-sm rounded px-3 text-primary tracking-wide">Back</button>
