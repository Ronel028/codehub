...
const Profile = ({ user }) => {
  return (
    <>
      <div className="overflow-hidden rounded-md border border-stroke bg-gray-200/80 shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-35 md:h-65">
          <img
            src={user.cover?.path ?? coverPlaceholder}
            alt="profile cover"
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11">
          <div className="relative z-30 mx-auto -mt-24 h-30 w-full max-w-30 rounded-full bg-very-light p-1 sm:h-44 sm:max-w-44 sm:p-1">
            <div className="relative drop-shadow-2">
              <img src={user.avatar?.path ?? profilePlaceholder} alt="profile" className=' rounded-full' />
            </div>
          </div>
          <div className="mt-4">
...

            {
              !isNull(user.user_detail) ? (
                  <div className="mx-auto mt-4 max-w-180">
