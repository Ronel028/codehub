                ...
                <div className="flex min-h-full items-start justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    >
                        ...
                        <div className="bg-gray-50 px-4 py-3 flex justify-end items-center gap-2 sm:px-6">
                            ...
                            <button onClick={save} disabled={processing} type="button" className="inline-flex w-full min-w-[78.38px] h-9 items-center justify-center rounded bg-yellow-light px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-opacity-90 sm:ml-3 sm:w-auto">
